    ...
    <x-container>
        <div class="mx-auto grid max-w-7xl grid-cols-1 gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
            <div class="mx-auto max-w-2xl lg:mx-0">
                ...
                <p class="mt-6 text-lg leading-8 text-gray-600">{!! $page->body !!}</p>
            </div>
            <ul role="list"
                ...
                @foreach ($members->where('is_staff', true) as $member)
                    <li>
                        <img class="aspect-[3/2] w-full rounded-2xl object-cover"
                            ...
                            alt="">
                        <h3 class="mt-6 text-lg font-semibold leading-8 text-gray-900">{{ $member->full_name }}</h3>
                        <p class="text-base leading-7 text-gray-600">{{ $member->styles }}</p>
                        <p class="mt-4 text-base leading-7 text-gray-600">{{ $member->description }}</p>
