                            ...
                            <table class="min-w-full divide-y divide-gray-300 table-alternate">
                                <thead>
                                    <tr class="bg-red-600 text-white">
                                        ...
                                        <th scope="col" class="hidden sm:table-cell px-3 py-3.5 text-left font-bold">Ort</th>
                                        <th scope="col" class="px-3 py-3.5 text-left font-bold">Kursbeginn</th>
                                        <th scope="col" class="hidden sm:table-cell px-3 py-3.5 text-left font-bold">Uhrzeit</th>
                                    ...
                                    @foreach ($subcategory->courses as $course)
                                        @if ($course->subcategory->is_club || $course->start_date > now())
                                            <tr>
                                                ...
                                                <td class="hidden sm:table-cell whitespace-nowrap px-3 py-4 text-base text-neutral-500">
