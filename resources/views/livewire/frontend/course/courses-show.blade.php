    ...
    <x-container>
        <x-grid cols="3">
            <x-grid.column class="col-span-2">
                <div>
                    <h2 class="text-3xl font-semibold tracking-tight text-gray-900">Kursbezeichnung</h2>
                ...
                @if ($course->subcategory->plan->count())
                    <div class="border-b border-gray-200 bg-white mt-12">
                        <h3 class="text-lg font-bold leading-6 py-4 px-3 bg-zinc-600 text-white rounded-t-lg">Kursplan
                        ...
                        <ul role="list" class="divide-y divide-gray-100 ">
                            @foreach ($course->subcategory->plan->sortBy('position') as $plan)
                                <li
                                    ...
                                    <p class="text-base font-semibold leading-6 text-gray-900">{{ $plan->position }}
                                        Std.
                                    </p>
            ...
            <x-grid.column>
                <div class="lg:col-start-3 bg-zinc-100 py-5 shadow-sm ring-1 ring-gray-900/5">
                    <h2 class="sr-only">Summary</h2>
                    <div class="rounded-lg ">
                        <dl class="flex flex-wrap">
                            <div class="flex-auto pl-6">
                                <dt class="text-lg font-medium leading-6 text-gray-900">Kurspreis</dt>
                                <dd class="mt-1   leading-6 text-gray-900">
                                    @if (!$totalPrice)
                                        ab
                                    @endif
                            ...
                            <div class="mt-6 flex w-full flex-none gap-x-4 border-t border-gray-900/5 px-6">
                                <dt class="flex-none">
                                ...
                                <dd class="text-base font-medium leading-6 text-gray-900">Tag:
                            ...
                            <div class="mt-4 flex w-full flex-none gap-x-4 px-6">
                                ...
                                <dd class="text-base font-medium leading-6 text-gray-900">
                            ...
                            <div class="mt-4 flex w-full flex-none gap-x-4 px-6">
                                ...
                                <dd class="text-base font-medium leading-6 text-gray-900">Veranstaltungsort: <br>
                                ...
                                <div class="flex flex-col justify-between px-3">
                                    <div class="flex space-x-2 mb-4">
                                        <div>
                                            <label for="quantityMen"
                                                class="block text-sm font-medium text-gray-700">Männer</label>
                                            <input wire:model.lazy="quantityMen" type="number" id="quantityMen"
                                                min="0"
                                                class="mt-1 flex-1 w-full border-gray-300 rounded-md shadow-sm">
                                        </div>
                                        <div>
                                            <label for="quantityWomen"
                                                class="block text-sm font-medium text-gray-700">Frauen</label>
                                    ...
                                    <form wire:submit.prevent="createSession">
                                        <button @if (!Auth::guard('customer')->check()) disabled @endif
                                            class="disabled:bg-gray-300 bg-red-500 w-full text-white py-2 px-4 rounded hover:bg-red-600"
                    ...
                    <ul role="list" class="divide-y divide-gray-100 mt-4">
                        ...
                        @if (isset($course->secondaryTeacher))
                            <li class="flex gap-x-4 py-5">
                                ...
                                <div class="min-w-0">
                                    <p class="text-base font-medium leading-6 text-gray-900">Michael Foster</p>
                                    <p class="mt-1 truncate text-sm leading-5">
