<div>
    ...
    <x-container>
        ...
        <p class="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-neutral-600">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta, corporis reiciendis laudantium magnam tenetur iure natus eius minus? Nemo similique, odio reprehenderit vitae maiores facilis. Iure aut perferendis odit voluptatum.</p>
                            ...
                            <label
                                ...
                                <span class="ml-3 flex flex-col">
                                    <span id="rate-{{ $loop->index }}-label"
                                        class="block text-base font-regular text-neutral-900">{{ $rate->name }}, <span class="font-bold">{{ formatPriceGerman($rate->amount)  }},€</span></span>
